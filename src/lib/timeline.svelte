...
>
	...
	>
		<svelte:component this={experienceCard} experience={kopanoAi} order="order-2 md:order-1" />
		<!-- Icon -->
		<div
		...
		<div class="hidden md:flex flex-1 w-[calc(100%-4rem)] p-4 rounded mx-5 order-3 md:order-3">
			<div class="flex flex-row items-end justify-end space-x-2">
				<div class="font-bold">
					<time datetime="2018-04-01">{kopanoAi.dateFrom}</time>
					-
					<time datetime="2018-10-30">{kopanoAi.dateTo}</time>
				</div>
			</div>
		</div>
	</div>
	...
	>
		...
		>
			<div class="flex flex-row items-end justify-end space-x-2">
				<div class="font-bold">
					<time datetime="2018-08-30">{dynexIt.dateFrom}</time>
					-
					<time datetime="2020-12-30">{dynexIt.dateTo}</time>
				</div>
			</div>
		</div>
		...
		<!-- Card -->
		<svelte:component this={experienceCard} experience={dynexIt} order="order-3 md:order-3" />
	</div>
	...
	>
		...
		<div class="hidden md:flex flex-1 w-[calc(100%-4rem)] p-4 rounded mx-5 order-3 md:order-3">
			<div class="flex items-center justify-between space-x-2">
				<div class="font-bold">
					<time datetime="2018-04-01">{entelectStdBank.dateFrom}</time>
					-
					<time datetime="2018-10-30">{entelectStdBank.dateTo}</time>
				</div>
			</div>
		</div>
	</div>
	...
	<div
		class="relative flex md:flex-row items-center justify-start md:items-center md:justify-between group is-active flex-wrap"
	>
		<svelte:component this={experienceCard} experience={entelectOM} order="order-3 md:order-3" />
		<!-- Icon -->
		<div
			class="flex items-center justify-center w-10 h-10 rounded-full bg-surface-50 text-white-500 shadow shrink-0 order-1 md:order-2 p-1"
		>
